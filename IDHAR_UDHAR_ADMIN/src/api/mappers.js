...
export function mapOrder(row) {
  ...
  return {
    ...
    tripFare: fare,
    netPayable: payable,
    distanceKm: row.distance_km == null ? null : money(row.distance_km),
    baseFare: row.base_fare == null ? null : money(row.base_fare),
    perKm: row.per_km == null ? null : money(row.per_km),
    distanceCharge: row.distance_charge == null ? null : money(row.distance_charge),
    waitingCharge: row.waiting == null ? null : money(row.waiting),
    surgeCharge: row.surge == null ? null : money(row.surge),
    tollCharge: row.toll == null ? null : money(row.toll),
    parkingCharge: row.parking == null ? null : money(row.parking),
    discount: row.discount == null ? null : money(row.discount),
    fareRiderPercentage: row.fare_rider_percentage == null ? null : money(row.fare_rider_percentage),
...
export function mapVehicleCategory(row) {
  ...
  return {
    ...
    riderSharePercent: rates.rider_percentage == null || rates.rider_percentage === '' ? 85 : money(rates.rider_percentage),
