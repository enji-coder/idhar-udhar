...
class OutlineButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final Color fg = foregroundColor ?? AppColors.navyDeep;
    final Color border = borderColor ?? AppColors.navy.withOpacity(0.35);
                    ...
                    if (isLoading)
                      ...
                      Flexible(
                        child: Text(
                          ...
                          style:
                              AppTextStyles.buttonSecondary.copyWith(color: fg),
                        ),
                      ),
                    ],
                  ],
